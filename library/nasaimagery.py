...
def run_module():
    ...
    module_args = dict(
        ...
        date=dict(type='str', required=False, default="2020-01-01")
    )
    ...
    nasaurl = f"https://api.nasa.gov/planetary/earth/assets/?lon={ module.params['lon'] }&lat={ module.params['lat'] }&date={ module.params['date']}&api_key={ module.params['apikey'] }"
